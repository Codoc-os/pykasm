...
class SessionSyncClient(SessionClientABC):
    """Synchronous implementation of `SessionClientABC` using `requests`."""
    ...
    def request(
        ...
        return self.client.post("request-session", json=payload, raise_on_error=raise_on_error)
    ...
    def status(
        ...
        return self.client.post("status-session", json=payload, raise_on_error=raise_on_error)

    def join(self, user_id: str, shared_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("join-session", json=payload, raise_on_error=raise_on_error)

    def get(self, raise_on_error: bool = True) -> ClientResponse:
        ...
        """
        return self.client.post("get-sessions", raise_on_error=raise_on_error)

    def destroy(self, user_id: str, session_id: str, raise_on_error: bool = True, **kwargs: Any) -> ClientResponse:
        ...
        return self.client.post("destroy-session", json=payload, raise_on_error=raise_on_error)

    def keepalive(self, session_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("keepalive-session", json=payload, raise_on_error=raise_on_error)
    ...
    def execute(
        ...
        return self.client.post("execute-session", json=payload, raise_on_error=raise_on_error)
