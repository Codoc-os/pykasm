...
class UserSyncClient(UserClientABC):
    ...
    def create(
        ...
        return self.client.post("create-user", json=payload, raise_on_error=raise_on_error)

    def get(self, *, user_id: str = None, username: str = None, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("get-users", raise_on_error=raise_on_error)
    ...
    def update(
        ...
        return self.client.post("update-user", json=payload, raise_on_error=raise_on_error)

    def delete(self, user_id: str, force: bool = False, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("delete-user", json=payload, raise_on_error=raise_on_error)

    def logout(self, user_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("logout-user", json=payload, raise_on_error=raise_on_error)

    def get_attributes(self, user_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        """
        payload = {"target_user": {"user_id": user_id}}
        return self.client.post("get-user-attributes", json=payload, raise_on_error=raise_on_error)
    ...
    def update_attributes(
        ...
        return self.client.post("update-user-attributes", json=payload, raise_on_error=raise_on_error)

    def add_to_group(self, user_id: str, group_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("add-user-group", json=payload, raise_on_error=raise_on_error)

    def remove_from_group(self, user_id: str, group_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        """
        payload = {"target_user": {"user_id": user_id}, "target_group": {"group_id": group_id}}
        return self.client.post("remove-user-group", json=payload, raise_on_error=raise_on_error)

    def assign_server(self, user_id: str, server_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        return self.client.post("assign-user-server", json=payload, raise_on_error=raise_on_error)

    def unassign_server(self, user_id: str, server_id: str, raise_on_error: bool = True) -> ClientResponse:
        ...
        """
        payload = {"target_user": {"user_id": user_id}, "target_server": {"server_id": server_id}}
        return self.client.post("unassign-user-server", json=payload, raise_on_error=raise_on_error)
